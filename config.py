...
class ExportConfig:
    ...
    episodes_dir: Path = field(default_factory=lambda: Path("data/leorover_nav/episodes"))
    output_dir: Path = field(default_factory=lambda: Path("data/leorover_nav/lerobot"))
    repo_id: str = "<HF_DATASET_REPO>"
    robot_type: str = "leorover"
    fps: int = 10
