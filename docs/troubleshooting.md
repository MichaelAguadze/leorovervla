...
Most leorover images already provide OpenCV. If yours does not, fix the robot image first instead of assuming `pip install opencv-python` will be reliable on the robot.
