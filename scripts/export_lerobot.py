#!/usr/bin/env python3
"""Export accepted leorover episodes to a LeRobot-compatible dataset."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(description="Export leorover episodes to LeRobot format")
...
def derive_repo_id(episodes_dir: Path, output_dir: Path, requested_repo_id: str) -> str:
    ...
    dataset_name = episodes_dir.parent.name or output_dir.parent.name or "leorover"
